    ...
    <div class="rent-center container">
      <a href="../product/product.html">
        <div class="box">
          <div class="top">
            <div class="overlay">
              <img src="{{asset('/asset/bedroom-image/b1.jpg')}}" alt="" />
            </div>
      ...
      <a href="../product/product.html">
        <div class="box">
          <div class="top">
            <div class="overlay">
              <img src="{{asset('/asset/bedroom-image/b2.jpg')}}" alt="" />
            </div>
      ...
      <a href="../product/product.html">
        <div class="box">
          <div class="top">
            <div class="overlay">
              <img src="{{asset('/asset/bedroom-image/b3.jpg')}}" alt="" />
            </div>
      ...
      <a href="">
        <div class="box">
          <div class="top">
            <div class="overlay">
              <img src="{{asset('/asset/bedroom-image/b4.jpg')}}" alt="" />
            </div>
      ...
      <a href="">
        <div class="box">
          <div class="top">
            <div class="overlay">
              <img src="{{asset('/asset/bedroom-image/b5.jpg')}}" alt="" />
            </div>
      ...
      <a href="">
        <div class="box">
          <div class="top">
            <div class="overlay">
              <img src="{{asset('/asset/bedroom-image/b6.jpg')}}" alt="" />
            </div>
      ...
      <a href="">
        <div class="box">
          <div class="top">
            <div class="overlay">
              <img src="{{asset('/asset/bedroom-image/b7.jpg')}}" alt="" />
            </div>
      ...
      <a href="">
        <div class="box">
          <div class="top">
            <div class="overlay">
              <img src="{{asset('/asset/bedroom-image/b8.jpg')}}" alt="" />
            </div>
