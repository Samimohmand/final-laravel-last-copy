...
<section class="section rent">
    <div class="title">
      <h1>Properties for light bright</h1>
      <p>
    ...
    <div class="rent-center container">
      <a href="../product/product.html">
        <div class="box">
          <div class="top">
            <div class="overlay">
              <img src="{{asset('/asset/bright-light/l1.jpg')}}" alt="" />
            </div>
      ...
      <a href="../product/product.html">
        <div class="box">
          <div class="top">
            <div class="overlay">
              <img src="{{asset('/asset/bright-light/l2.jpg')}}"  alt="" />
            </div>
      ...
      <a href="../product/product.html">
        <div class="box">
          <div class="top">
            <div class="overlay">
              <img src="{{asset('/asset/bright-light/l3.jpg')}}"  alt="" />
            </div>
      ...
      <a href="">
        <div class="box">
          <div class="top">
            <div class="overlay">
              <img src="{{asset('/asset/bright-light/l4.jpg')}}"  alt="" />
            </div>
      ...
      <a href="">
        <div class="box">
          <div class="top">
            <div class="overlay">
              <img src="{{asset('/asset/bright-light/l5.jpg')}}"  alt="" />
            </div>
      ...
      <a href="">
        <div class="box">
          <div class="top">
            <div class="overlay">
              <img src="{{asset('/asset/bright-light/l6.jpg')}}"  alt="" />
            </div>
      ...
      <a href="">
        <div class="box">
          <div class="top">
            <div class="overlay">
              <img src="{{asset('/asset/bright-light/l7.jpg')}}"  alt="" />
            </div>
      ...
      <a href="">
        <div class="box">
          <div class="top">
            <div class="overlay">
              <img src="{{asset('/asset/bright-light/l8.jpg')}}"  alt="" />
            </div>
